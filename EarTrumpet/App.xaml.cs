...
namespace EarTrumpet
{
    public partial class App
    {
        ...
        private void ContinueStartup()
        {
            ...
            _collectionViewModel.TrayPropertyChanged +=
        ...
        {
            var ret = new List<ContextMenuItem>(_collectionViewModel.AllDevices.OrderBy(x => x.DisplayName).Select(
                dev => new ContextMenuItem
                {
            ...
            ret.AddRange(new List<ContextMenuItem>
            {
                ...
                new ContextMenuItem
                {
                    ...
                    Children = new List<ContextMenuItem>
                    {
                        new ContextMenuItem
                        {
                            DisplayName = EarTrumpet.Properties.Resources.LegacyVolumeMixerText,
                            Command = new RelayCommand(LegacyControlPanelHelper.StartLegacyAudioMixer)
                        },
                        new ContextMenuItem
                        {
                            DisplayName = EarTrumpet.Properties.Resources.PlaybackDevicesText,
                            Command = new RelayCommand(() => LegacyControlPanelHelper.Open("playback"))
                        },
                        new ContextMenuItem
                        {
                            DisplayName = EarTrumpet.Properties.Resources.RecordingDevicesText,
                            Command = new RelayCommand(() => LegacyControlPanelHelper.Open("recording"))
                        },
                        new ContextMenuItem
                        {
                            DisplayName = EarTrumpet.Properties.Resources.SoundsControlPanelText,
                            Command = new RelayCommand(() => LegacyControlPanelHelper.Open("sounds"))
                        },
                        new ContextMenuItem
                        {
                            DisplayName = EarTrumpet.Properties.Resources.OpenSoundSettingsText,
            ...
            var addonItems = AddonManager.Host.TrayContextMenuItems?.OrderBy(x => x.Items.FirstOrDefault()?.DisplayName)
                .SelectMany(ext => ext.Items);
            ...
            ret.AddRange(new List<ContextMenuItem>
            {
                new ContextMenuItem
                {
                    DisplayName = EarTrumpet.Properties.Resources.FullWindowTitleText,
                    Command = new RelayCommand(_mixerWindow.OpenOrBringToFront)
                },
                new ContextMenuItem
                {
                    DisplayName = EarTrumpet.Properties.Resources.SettingsWindowText,
                    Command = new RelayCommand(_settingsWindow.OpenOrBringToFront)
                },
                new ContextMenuItem
                {
                    DisplayName = EarTrumpet.Properties.Resources.ContextMenuExitTitle,
        ...
        private Window CreateSettingsExperience()
        {
            var defaultCategory = new SettingsCategoryViewModel(
                ...
                new SettingsPageViewModel[]
                {
                    ...
                    new AdditionalSettingsViewModel(),
            ...
            if (AddonManager.Host.SettingsItems != null)
                allCategories.AddRange(
                    AddonManager.Host.SettingsItems.Select(a => a.Get(AddonManager.FindAddonInfoForObject(a))));
        ...
        {
            return new FullWindow {DataContext = new FullWindowViewModel(_collectionViewModel)};
        }
    }
}